...
bool BitFsPyramidOscillation_GetMinimumDownhillWalkingAngle::validation()
{
	...
	auto marioObj =
		(PyramidUpdateMem::Sm64Object*) (resource->addr("gMarioObject"));
...
bool BitFsPyramidOscillation_GetMinimumDownhillWalkingAngle::execution()
{
	...
	auto marioState =
		(PyramidUpdateMem::Sm64MarioState*) (resource->addr("gMarioStates"));
	...
	CustomStatus.isSlope =
		PyramidUpdateMem::FloorIsSlope(floor, marioState->action);
