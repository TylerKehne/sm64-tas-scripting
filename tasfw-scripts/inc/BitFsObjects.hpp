...
// pipeline hands this list to LibSm64Config::expectedObjects so the per-thread layout check
// fails start-up loudly if a slot ever holds something else.
inline const std::vector<LibSm64ExpectedObject> BitFsExpectedObjects = {
